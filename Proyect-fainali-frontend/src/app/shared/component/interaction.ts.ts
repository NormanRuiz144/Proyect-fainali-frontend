...
@Component({
  ...
  styles: `
    ...
    .border-azul { border-top: 5px solid #3d39af; }
    .icono-alerta {
      width: 50px;
      height: 50px;
      background: #ebf0ff;
    ...
    .titulo-alerta { color: #3d39af; margin-bottom: 10px; }
    .btn-cancelar { background: #f1f2f6; color: #2d3436; }
    .btn-cancelar:hover { background: #dfe4ea; }

    .border-rojo { border-top: 5px solid #e74c3c; }
    .icono-error {
      width: 50px;
      height: 50px;
      background: #fdeaea;
    ...
    .titulo-error { color: #c0392b; margin-bottom: 10px; }
    .btn-error {
      background: #e74c3c;
      color: white;
      width: 100%;
    ...
    .btns { display: flex; gap: 10px; margin-top: 20px; justify-content: center; }
    button {
      padding: 10px 20px;
      border: none;
      border-radius: 10px;
    ...
    .principal { background: #3d39af; color: white; }
    .principal:hover { background: #2d2a8a; }
  `,
})
